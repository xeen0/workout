...
const Graph = ({ children }) => {
	...
	return (
		<div className=" mx-auto overflow-hidden p-6 bg-white border border-gray-200 rounded-lg shadow-lg mt-3 ">
			...
			<div className="relative flex ">
				...
				<div className="flex self-end items-end h-16 ">
					{nodes.length == 0 && (
						...
						index != 0 && (
							<span
								...
								className={` text-gray-400 flex-1 ${
									...
									index % 2 == 0 || index == Math.ceil(totalDistance)
										? 'visible'
										: 'invisible'
								}`}>
								{index}
